...
Partial Class ClientInformation
    ...
    Dim connStr As String = "Server=LAPTOP-0UAHSB98;Database=Main;User Id=sa;Password=admin123;"
    ...
    Protected Sub txtSearch_TextChanged(sender As Object, e As EventArgs)
        LoadCompanies()
        LoadAlerts() ' ✅ Keep alert visible after search
    End Sub
    ...
    Protected Sub ddlPageSize_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        LoadCompanies()
        LoadAlerts() ' ✅ Keep alert visible after page size change
    End Sub
    ...
    Protected Sub gvCompanies_PageIndexChanging(sender As Object, e As GridViewPageEventArgs)
        ...
        LoadCompanies()
        LoadAlerts() ' ✅ Keep alert visible after page change
    End Sub

    Protected Sub ddlStatusFilter_SelectedIndexChanged(sender As Object, e As EventArgs)
        LoadCompanies()
        LoadAlerts() ' ✅ Keep alert visible after status filter
    End Sub
